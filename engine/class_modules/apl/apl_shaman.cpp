...
{
  return ( p->true_level >= 71 ) ? "main_hand:algari_mana_oil_3,if=!talent.flametongue_weapon"
    : "disabled";
}
...
void elemental( player_t* p )
{
  ...
  default_->add_action( "use_item,slot=main_hand,use_off_gcd=1,if=(buff.storm_elemental.up|!talent.fury_of_the_storms|cooldown.stormkeeper.remains>10)&cooldown.ascendance.remains>15|buff.ascendance.remains>12", "Normal weapons" );
